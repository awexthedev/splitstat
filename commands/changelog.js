module.exports = {
    ...
    execute(message, MessageEmbed) {
      ...
      .addFields(
        { name: `Added Linking Ability`, value: `This adds the **linking** feature. You can run **spl!link [your-steam-vanity-url]** to let SplitStat save your Steam ID and your Discord ID -- if you do this, you'll only need to run **spl!lookup** since the bot already knows who you are!\nThis does **not** store anything else but your Steam64ID.` },
